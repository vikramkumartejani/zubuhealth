...
const KeyBenefits: React.FC = () => {
  return (
    <div className="bg-dark_green md:px-32 py-20 px-6 flex items-center gap-8 justify-between lg:flex-row flex-col">
      <div>
        <h3 className="md:text-5xl text-3xl text-white text-center sm:text-left font-medium mb-14">Key 
        ...
        <ul className="text-white text-xl font-normal leading-10 grid sm:grid-cols-2 grid-cols-1 md:gap-4 gap-3">
